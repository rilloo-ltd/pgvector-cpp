...
OBJS = src/bitutils.o src/bitvec.o src/halfutils.o src/halfvec.o src/hnsw.cpp.o src/hnswbuild.cpp.o src/hnswinsert.cpp.o src/hnswscan.cpp.o src/hnswutils.cpp.o src/hnswvacuum.cpp.o src/ivfbuild.o src/ivfflat.o src/ivfinsert.o src/ivfkmeans.o src/ivfscan.o src/ivfutils.o src/ivfvacuum.o src/sparsevec.o src/vector.o
